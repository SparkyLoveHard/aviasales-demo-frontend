            ...
            <div className="col-md-10 col-md-offset-1 col-lg-offset-0 col-lg-12 col-xl-10 col-xl-offset-1">
              <div className="row between-lg">
                ...
                <BestPriceCard className="col-xs-12 col-md-12 col-lg-offset-0">
                  ...
                  <CitiesAndPrice>
                    <FromDeparture>Из Сочи</FromDeparture>
                    <Price>от 15 127 р</Price>
                  </CitiesAndPrice>
                  <CitiesAndPrice>
                    <FromDeparture>Из Краснодара</FromDeparture>
                    <Price>от 9 275 р</Price>
                  </CitiesAndPrice>
                  <CitiesAndPrice>
                    <FromDeparture>Из Ростова-на-Дону</FromDeparture>
                    <Price>от 9 148 р</Price>
                  </CitiesAndPrice>
                </BestPriceCard>
                <Line/>
                <BestPriceCard className="col-xs-12 col-md-12 col-lg-offset-0">
                  <TitleBlock>
                    ...
                    <div>
                      <TitleNameCity>Кишинёв</TitleNameCity>
                  ...
                  <CitiesAndPrice>
                    <FromDeparture>Из Сургута</FromDeparture>
                    <Price>от 9 275 р</Price>
                  </CitiesAndPrice>
                  <CitiesAndPrice>
                    <FromDeparture>Из Нового Уренгоя</FromDeparture>
                    <Price>от 9 148 р</Price>
                  </CitiesAndPrice>
                </BestPriceCard>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 center-xs  col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3">
              <Text>Мы знаем, где купить авиабилеты дешево. Билеты на самолет в 220 стран мира. Поиск и сравнение цен на авиабилеты среди 100 агентств и 728 авиакомпаний.</Text>
            </div>
            <div className="col-xs-12 center-xs  col-md-10 col-md-offset-1 col-lg-6 col-lg-offset-3">
              <Rule>Цены, найденные пользователями за последние 48 часов, не являются офертой.</Rule>
            </div>
          </div>
        </div>
      </div>
