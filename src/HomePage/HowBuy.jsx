        ...
        <div className="row">
          <div className="col-xs-12 col-md-12 col-lg-10 col-lg-offset-1">
            ...
            <Text>
              ...
              дешевые авиабилеты. Чтобы купить авибилеты дешево, воспользуюсь
              нашим поиском, который совершенно бесплатно сравнивает цены на
              авиабилеты онлайн и находит самые дешевые перелеты. Болльше нет
              смысла ходить в авиакассы, обзванивать агенства - дешевый билет
              находтся на расстоянии клика. На нашем сайте вы можете подобрать
          ...
          <div className="col-xs-12 col-md-12 col-lg-10 col-lg-offset-1">
            ...
            <Text>
              ...
              формата А4, на котором распечатана вся информация о пердстоящем
              перелете. Однако для действиельно официальный документ,
